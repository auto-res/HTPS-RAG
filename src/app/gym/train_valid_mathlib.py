...
from src.app.constants import TRAIN_DATA_PATH, BATCH_SIZE, LEANDOJO_BENCHMARK
...
def main():
    ...
    generator, estimator, prover, tokenizer = setup_model(benchmark=LEANDOJO_BENCHMARK)

    # Clear the training data file.
    with open(TRAIN_DATA_PATH, 'w') as f:
        pass
    
    train_acc_history = AccuracyHistory()
    ...
    for block_num in range(block_start, block_count):
        ...
        # Update the model.
        train_acc_history.add(get_accuracy(results))

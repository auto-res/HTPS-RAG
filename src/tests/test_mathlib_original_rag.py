...
def main():
    ...
    generator = RetrievalAugmentedGenerator(
        ...
        eval_num_theorems=1,
        max_seq_len=512,
        retriever_name="autores/reprover-retriever-lean4-v1.0",
        corpus_path="src/data/leandojo_benchmark_4/corpus.jsonl"
        )
    ...
    # mathlib4に変更
    repo, theorems, positions = get_theorems_from_repo_url("https://github.com/leanprover-community/mathlib4", "3ce43c18f614b76e161f911b75a3e1ef641620ff")
